...
**Built for Quantitative Analysts** | Real-time Insights | Forecasting with ARIMA
""")
...
# Fetch daily and 1-minute intraday data
try:
    ...
    st.sidebar.warning("⚠️ Failed to fetch price data.")
...
if use_forecast and not data.empty:
    try:
